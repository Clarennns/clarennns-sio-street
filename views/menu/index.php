        ...
        <div class="menus">
            <?php foreach ($menus as $menu): ?>
                <div class="card">
                    ...
                    <p><?php echo htmlspecialchars($menu->getDescription()); ?></p>
                    ...
                    <?php else: ?>
                        <?php if ($isLoggedIn): ?>
                            <?php if (isset($_SESSION['user_role']) && $_SESSION['user_role'] === 'client'): ?>
                                <a href="index.php?controller=panier&action=add&item_type=menu&item_id=<?php echo $menu->getId(); ?>">Commander</a>
                            <?php endif; ?>
                        <?php else: ?>
                            <a href="index.php?controller=user&action=login">Commander</a>
                        <?php endif; ?>
                    <?php endif; ?>
                </div>
            <?php endforeach; ?>
