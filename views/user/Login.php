...
<head>
    ...
    <style>
        ...
        header { margin: 0; }
        .auth-wrapper { max-width: 620px; margin: 40px auto; background: #fff; border-radius: 10px; box-shadow: 0 6px 20px rgba(0,0,0,.08); padding: 28px; }
...
<body>
    ...
    <section class="auth-wrapper">
        ...
        <form class="auth-form" action="index.php?controller=user&action=login" method="POST">
            <div class="row">
